...
class RSA {
    constructor(keys) {
        ...
        this.findKey = function (firstPrimeNumber, secondPrimeNumber) {
            ...
            return {
                publicKey: {e:ed.e.toString(35) , n: n.toString(35)},
                privateKey: {d: ed.d.toString(35) ,n: n.toString(35)}
            };
        };
        ...
        this.decrypt = function (string) {
            ...
            for (var i in intToDecrypt) {
                var intChar = bigInt(intToDecrypt[i], 35).modPow(objectKeys.privateD, objectKeys.privateN), stringChar = intChar.toString(10);
            ...
            for (var i = 0; i < initialChainCharLength; i += 3) {
                ...
                if (charCode != 0)
                    decryptedChain += String.fromCharCode(charCode);
            }
